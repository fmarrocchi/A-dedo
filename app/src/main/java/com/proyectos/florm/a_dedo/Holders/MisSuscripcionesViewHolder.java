...
public class MisSuscripcionesViewHolder extends RecyclerView.ViewHolder{
    private View view;
    private Button botonDesuscribir;
    ...
    public MisSuscripcionesViewHolder(View itemView) {
        super(itemView);
        view = itemView;
        botonDesuscribir = view.findViewById(R.id.btn_desuscribir);
    ...
    public Button getBotonDesuscribir() {
        return botonDesuscribir;
    }
    ...
    public void ocultar(){
        botonDesuscribir.setVisibility(View.GONE);
